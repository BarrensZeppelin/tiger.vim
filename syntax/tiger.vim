""
"" tiger.vim for Tiger Vim Syntax File
""
"" Made by Florent Thoumie 
"" Login   <flz@epita.fr>
""
"" Started on  Mon Jan 13 11:24:50 2003 Florent Thoumie 
"" Updated on  Sun Jan 19 19:07:25 2003 florent thoumie
"" Updated on  Thu Sep 24 13:38:07 2020 Oskar Haarklou Veileborg
""

" Vim syntax file
" Language:    Tiger
" Maintainer:    Florent Thoumie <flz@epita.fr>
" Version:    0.2
...
syn keyword    tigerFunctions        print print_int flush getchar concat
syn keyword    tigerFunctions        ord chr size substring not exit

syn region     tigerComment        start="/\*" end="\*/" contains=tigerTodo
syn region     tigerString        start=+"+ end=+"+ skip=+\\\\|\\"+ contains=tigerEscaped
...
if version >= 508 || !exists("did_tiger_syn_inits")
    ...
    HiLink tigerTodo            Underlined   " Todo
    HiLink tigerComment         Comment
    HiLink tigerString          String
    HiLink tigerConditional     Structure    " Conditional
    HiLink tigerLoop            Structure    " Conditional
    HiLink tigerStatement       Structure    " Statement
    HiLink tigerNumbers         Number
    HiLink tigerDefinition      Identifier
